...
<div class="p-4 sm:ml-64">
      ...
      <form action="proses-tambah.php" method="POST">
          <div w-full="grid gap-4 sm:grid-cols-2 sm:gap-6">
              ...
              <div class="sm:col-span-2">
                ...
                <div class="sm:col-span2">
                        <button type="submit" class="text-white bg-blue-700
    hover:bg-blue-800  focus:ring-4  focus:outline-none  focus:ring-blue-300
    font-meedium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600
    ...
    text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z10 dark:bg-
