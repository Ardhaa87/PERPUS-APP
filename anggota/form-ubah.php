...
<div class="p-4 sm:ml-64">
    ...
    <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Ubah Data Anggota</h2>
      <form action="proses-ubah.php" method="POST">
          <div w-full="grid gap-4 sm:grid-cols-2 sm:gap-6">
              <div class="w-full">
              ...
              <div>
                ...
                <div
                 class="sm:col-span2">
                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800  focus:ring-4  focus:outline-none  focus:ring-blue-300 font-meedium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark-hover:bg-blue-700 dark:focus:ring-blue-800">Simpan</button>
                <button type="button" onclick="history.back()" class="ms-3  text-gray-500  bg:white  hover:bg-gray-100  focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z10 dark:bg- dark:hover:bg-gray-600 dark:focus:ring-gray-600">Batal</button>
             </div>
      </form>
    </div>
</div>
